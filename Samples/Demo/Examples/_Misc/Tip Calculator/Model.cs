	...
	***************************************************************************************************/
	...
	public class Model : DependencyObject, INotifyPropertyChanged
	{
		...
		***********************************************************/
		...
		public static DependencyProperty<decimal, Model> BillProperty { get; } = DependencyProperty<decimal, Model>
			.Register()
		...
		***********************************************************/
		...
		public static DependencyProperty<int, Model> TipPercentProperty { get; } = DependencyProperty<int, Model>
			.Register()
		...
		***********************************************************/
		...
		public static DependencyProperty<int, Model> NumPeopleProperty { get; } = DependencyProperty<int, Model>
			.Register()
		...
		***********************************************************/
		...
		public static DependencyProperty<decimal, Model> TipPerPersonProperty { get; } = DependencyProperty<decimal, Model>
			.Register();
